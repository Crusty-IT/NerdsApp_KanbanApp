...
namespace KanbanApp.Backend.Migrations
{
    ...
    [Migration("20260515160000_AddObjectPositions")]
    partial class AddObjectPositions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KanbanApp.Backend.Models.Board", b =>
                {
                    ...
                    b.Property<string>("CoverObjectPosition").HasColumnType("text");
            ...
            modelBuilder.Entity("KanbanApp.Backend.Models.BoardMember", b =>
                {
                    ...
                    b.Property<int>("BoardId").HasColumnType("integer");
            ...
            modelBuilder.Entity("KanbanApp.Backend.Models.Card", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("integer");
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Id"));
                    b.Property<string>("AssignedToUserId").HasColumnType("text");
            ...
            modelBuilder.Entity("KanbanApp.Backend.Models.CardImage", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("integer");
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Id"));
                    b.Property<int>("CardId").HasColumnType("integer");
                    b.Property<string>("ContentType").IsRequired().HasColumnType("text");
                    b.Property<string>("FileName").IsRequired().HasColumnType("text");
                    b.Property<string>("ObjectPosition").HasColumnType("text");
                    b.Property<DateTime>("UploadedAt").HasColumnType("timestamp with time zone");
                    b.Property<string>("UploadedByUserId").IsRequired().HasColumnType("text");
            ...
            modelBuilder.Entity("KanbanApp.Backend.Models.Board", b =>
                {
                    b.HasOne("KanbanApp.Backend.Models.Project", "Project").WithMany("Boards").HasForeignKey("ProjectId");
                    b.Navigation("Project");
                });

            modelBuilder.Entity("KanbanApp.Backend.Models.BoardMember", b =>
                {
                    b.HasOne("KanbanApp.Backend.Models.Board", "Board").WithMany("BoardMembers").HasForeignKey("BoardId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.HasOne("KanbanApp.Backend.Models.ApplicationUser", "User").WithMany("BoardMembers").HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Board");
                    b.Navigation("User");
                });
            ...
            modelBuilder.Entity("KanbanApp.Backend.Models.Card", b =>
                {
                    b.HasOne("KanbanApp.Backend.Models.Column", "Column").WithMany("Cards").HasForeignKey("ColumnId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Column");
                });

            modelBuilder.Entity("KanbanApp.Backend.Models.CardImage", b =>
                {
                    b.HasOne("KanbanApp.Backend.Models.Card", "Card").WithMany("Images").HasForeignKey("CardId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Card");
                });

            modelBuilder.Entity("KanbanApp.Backend.Models.Column", b =>
                {
                    b.HasOne("KanbanApp.Backend.Models.Board", "Board").WithMany("Columns").HasForeignKey("BoardId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Board");
                });

            modelBuilder.Entity("KanbanApp.Backend.Models.Notification", b =>
                {
                    b.HasOne("KanbanApp.Backend.Models.ApplicationUser", "User").WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("User");
                });

            modelBuilder.Entity("KanbanApp.Backend.Models.Project", b =>
                {
                    b.HasOne("KanbanApp.Backend.Models.ApplicationUser", "Owner").WithMany().HasForeignKey("OwnerId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Owner");
                });

            modelBuilder.Entity("KanbanApp.Backend.Models.ProjectMember", b =>
                {
                    b.HasOne("KanbanApp.Backend.Models.Project", "Project").WithMany("Members").HasForeignKey("ProjectId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.HasOne("KanbanApp.Backend.Models.ApplicationUser", "User").WithMany("ProjectMembers").HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Project");
                    b.Navigation("User");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("KanbanApp.Backend.Models.ApplicationUser", null).WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                });
